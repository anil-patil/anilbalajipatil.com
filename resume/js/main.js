...
$(document).ready(function(){
  ...
  function filling_bar(){
    ...
    var h_fill_bar = document.getElementById('h_count');
    ...
    var h_fill_bar_content = document.getElementById('h_count_id');
    ...
    var h_id = setInterval(h_filling_frame, 10);
    ...
    function html_filling_frame(){
      if (html_width >= 90){
        ...
        html_fill_bar_content.textContent = 'HTML, CSS, JavaScript ' + html_width +'%';
      }
    }

    function h_filling_frame(){
      if (h_width >= 85){
        clearInterval(h_id);
      }else{
        h_width++;
        h_fill_bar.style.width = h_width + '%';
        h_fill_bar_content.textContent = 'Bootstrap ' + h_width +'%';
      }
    }
    function css_filling_frame(){
      if (css_width >= 90) {
        ...
        css_fill_bar_content.textContent = 'AngularJS  ' + css_width +'%';
      }
    }
    function bs_filling_frame(){
      if (bs_width >= 80) {
        ...
        bs_fill_bar_content.textContent = 'Angular Learning '+ bs_width +'%';
      }
    }
    function js_filling_frame(){
      if (js_width >= 70) {
        ...
        js_fill_bar_content.textContent = 'JQuery '+ js_width +'%';
      }
    }
    ...
    //     jquery_fill_bar_content.textContent = 'learining angular 5/6, NodeJS ';
    //   }
    // }
  }
